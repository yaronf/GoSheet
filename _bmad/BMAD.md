...
1. **Check BMAD Before Starting**: At the beginning of EVERY user interaction session
   - Read _bmad/BMAD.md to understand current project state
...
2. **Bug Fix Testing**: Every bug fix MUST include at least one regression test
   ...
   - Add bug fix details to _bmad/BMAD.md decision log
...
4. **Documentation in Code**: Important rules and decisions must be documented
   ...
   - Update _bmad/BMAD.md with methodology decisions
...
3. **Documentation Current**
   - ✅ _bmad/BMAD.md reflects current architecture and decisions
   - ✅ README.md has accurate setup/running instructions
   - ✅ All new features documented in _bmad/BMAD.md "Bug Fixes and Improvements"
...
1. **Product Brief** (`_bmad-output/planning-artifacts/specs/PRODUCT_BRIEF.md`)
   - Problem statement
   - Target users
...
2. **Technical Specification** (`_bmad-output/planning-artifacts/specs/TECH_SPEC.md`)
...
3. **Formula Grammar Specification** (`_bmad-output/planning-artifacts/specs/FORMULA_GRAMMAR.md`)
...
- Comprehensive specs in `_bmad-output/planning-artifacts/specs/` directory
...
- ✅ Test documentation in _bmad/BMAD.md
...
- ✅ **Documentation**: Test results and coverage documented in _bmad/BMAD.md
