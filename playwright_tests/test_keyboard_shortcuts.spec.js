...
test.describe('Keyboard Shortcuts Tests', () => {
  ...
  test('All menu items have correct accelerators', async ({ electronApp, window }) => {
    ...
    console.log('[Keyboard Shortcuts Test] Found accelerators:', Object.keys(accelerators));
    
    console.log('[Keyboard Shortcuts Test] All accelerators verified:', accelerators);
  });
  ...
  test('Cmd+N shortcut is registered', async ({ electronApp, window }) => {
    ...
    console.log('[Keyboard Shortcuts Test] Cmd+N shortcut is properly registered');
  });
  ...
  test('Cmd+S is disabled when no changes', async ({ electronApp, window }) => {
    ...
    console.log('[Keyboard Shortcuts Test] Cmd+S correctly disabled when no changes');
  });
  ...
  test('Cmd+S becomes enabled after changes', async ({ electronApp, window }) => {
    ...
    console.log('[Keyboard Shortcuts Test] Cmd+S correctly enabled after changes');
  });
  ...
  test('Formula bar allows text editing shortcuts', async ({ electronApp, window }) => {
    ...
    console.log('[Keyboard Shortcuts Test] Formula bar editing works correctly');
  });
  ...
  test('All shortcuts use CmdOrCtrl for cross-platform compatibility', async ({ electronApp, window }) => {
    ...
    const allUseCmdOrCtrl = await electronApp.evaluate(({ Menu }) => {
      ...
      return accelerators.every(acc => 
        !acc.includes('Cmd+') && !acc.includes('Ctrl+') || acc.includes('CmdOrCtrl')
      );
    });
    
    expect(allUseCmdOrCtrl).toBe(true);
    
    console.log('[Keyboard Shortcuts Test] All shortcuts use CmdOrCtrl for cross-platform compatibility');
  });
});
